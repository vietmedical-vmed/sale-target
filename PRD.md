...
| **Thêm sản phẩm** (nút ở thẻ KH) | Mở **popup** (trước đây bung form ngay dưới thẻ). Bố cục: hàng chọn phạm vi (PS / Nhóm SP / Bộ vật tư) chia cột đều nhau; **kiểu thêm** tách thành 2 lựa chọn *Vật tư riêng lẻ* / *Cả bộ* (trước đây là tick nhỏ nhét cạnh nhãn ô Sản phẩm) — bộ tên dạng **"Vật tư riêng lẻ - &lt;ngành&gt;"** vốn là rổ chứa vật tư lẻ chứ không phải bộ thật nên tự khoá *Cả bộ*, luôn ở chế độ chọn từng vật tư; dưới cùng là **danh sách tick nhiều sản phẩm**, mỗi dòng có ô đơn giá riêng. Có thêm 2 ô **Tháng thầu chính / Tháng thầu bổ sung** (`yyyy-mm`, **không bắt buộc**) — tháng thầu là thuộc tính của **nhóm SP** nên ghi lên cả 12 dòng của mọi SP thêm lần này, đúng như `commitGroupField` ở thẻ KH; để trống thì ghi null. Bấm 1 lần thêm hết (mỗi SP = 12 dòng, gọi API tuần tự, có đếm tiến độ). Vật tư đã có trong kế hoạch thì khoá tick và ghi rõ. Thêm xong giữ nguyên nhóm/bộ để thêm tiếp bộ khác. |
